...
ICESAT2_PARQUET=_data/icesat2/atl06_benchmark.parquet
WEIGHTS_DIR=_data/weights/

START_DATE=2019/01/01
END_DATE=2019/01/07

python3 full-workflow_v3_r1.py --start-date $START_DATE --end-date $END_DATE --lis-path $LIS_PATH --amsr2-dir $AMSR2_DIR --ceda-dir $CEDA_DIR --viirs-dir $VIIRS_DIR \
